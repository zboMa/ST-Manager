...
// 获取世界书列表
export async function listWorldInfo(params, signal = undefined) {
...
export async function searchWorldInfoDetail(payload) {
  const res = await fetch("/api/world_info/detail_search", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload),
  });
